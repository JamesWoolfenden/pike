...
var tFLookup = map[string]interface{}{
	"aws_accessanalyzer_analyzer":                                      awsAccessanalyzerAnalyzer,
	"aws_accessanalyzer_archive_rule":                                  awsAccessanalyzerArchiveRule,
	"aws_account_alternate_contact":                                    awsAccountAlternateContact,
	...
	"aws_ami_launch_permission":                                        awsAMILaunchPermission,
	...
	"aws_appsync_graphql_api":                                          awsAppsyncGraphqlAPI,
	...
	"aws_backup_vault_notifications":                                   awsBackupVaultNotifications,
	...
	"aws_bedrockagent_agent_action_group":                              awsBedrockagentAgentActionGroup,
	...
	"aws_bedrockagent_agent_knowledge_base_association":                awsBedrockagentAgentKnowledgeBaseAssociation,
	...
	"aws_cloudhsm_v2_cluster":                                          awsCloudhsmV2Cluster,
	...
	"aws_cloudwatch_query_definition":                                  awsCloudwatchQueryDefinition,
	...
	"aws_codestarnotifications_notification_rule":                      awsCodestarnotificationsNotificationRule,
	...
	"aws_detective_organization_admin_account":                         awsDetectiveOrganizationAdminAccount,
	...
	"aws_ec2_availability_zone_group":                                  awsEc2AvailabilityZoneGroup,
	...
	"aws_emrserverless_application":                                    awsEmrserverlessApplication,
	...
	"aws_fsx_openzfs_snapshot":                                         awsFsxOpenzfsSnapshot,
	...
	"aws_guardduty_invite_accepter":                                    awsGuarddutyInviteAccepter,
	...
	"aws_iam_group_policy_attachments_exclusive":                       awsIAMGroupPolicyAttachmentsExclusive,
	...
	"aws_imagebuilder_infrastructure_configuration":                    awsImagebuilderInfrastructureConfiguration,
	...
	"aws_inspector_resource_group":                                     awsInspectorResourceGroup,
	...
	"aws_ivs_recording_configuration":                                  awsIvsRecordingConfiguration,
	...
	"aws_licensemanager_grant":                                         awsLicensemanagerGrant,
	"aws_licensemanager_grant_accepter":                                awsLicensemanagerGrantAccepter,
	"aws_licensemanager_license_configuration":                         awsLicensemanagerLicenseConfiguration,
	...
	"aws_macie2_account":                                               awsMacie2Account,
	"aws_macie2_classification_export_configuration":                   awsMacie2ClassificationExportConfiguration,
	"aws_macie2_classification_job":                                    awsMacie2ClassificationJob,
	"aws_macie2_custom_data_identifier":                                awsMacie2CustomDataIdentifier,
	"aws_macie2_findings_filter":                                       awsMacie2FindingsFilter,
	"aws_macie2_invitation_accepter":                                   awsMacie2InvitationAccepter,
	"aws_macie2_member":                                                awsMacie2Member,
	"aws_macie2_organization_admin_account":                            awsMacie2OrganizationAdminAccount,
	...
	"aws_medialive_multiplex":                                          awsMedialiveMultIPlex,
	...
	"aws_networkmanager_link_association":                              awsNetworkmanagerLinkAssociation,
	...
	"aws_opensearchserverless_access_policy":                           awsOpensearchserverlessAccessPolicy,
	"aws_opensearchserverless_collection":                              awsOpensearchserverlessCollection,
	"aws_opensearchserverless_lifecycle_policy":                        awsOpensearchserverlessLifecyclePolicy,
	"aws_opensearchserverless_security_config":                         awsOpensearchserverlessSecurityConfig,
	"aws_opensearchserverless_security_policy":                         awsOpensearchserverlessSecurityPolicy,
	"aws_opensearchserverless_vpc_endpoint":                            awsOpensearchserverlessVPCEndpoint,
	...
	"aws_paymentcryptography_key":                                      awsPaymentcryptographyKey,
	"aws_paymentcryptography_key_alias":                                awsPaymentcryptographyKeyAlias,
	...
	"aws_prometheus_query_logging_configuration":                       awsPrometheusQueryLoggingConfiguration,
	...
	"aws_ram_principal_association":                                    awsRamPrincipalAssociation,
	...
	"aws_redshift_hsm_client_certificate":                              awsRedshiftHsmClientCertificate,
	...
	"aws_resiliencehub_resiliency_policy":                              awsResiliencehubResiliencyPolicy,
	...
	"aws_route53_key_signing_key":                                      awsRoute53KeySigningKey,
	...
	"aws_s3control_access_grants_instance":                             awsS3controlAccessGrantsInstance,
	"aws_s3control_access_grants_instance_resource_policy":             awsS3controlAccessGrantsInstanceResourcePolicy,
	"aws_s3control_access_grants_location":                             awsS3controlAccessGrantsLocation,
	"aws_s3control_access_point_policy":                                awsS3controlAccessPointPolicy,
	"aws_s3control_bucket":                                             awsS3controlBucket,
	"aws_s3control_bucket_lifecycle_configuration":                     awsS3controlBucketLifecycleConfiguration,
	...
	"aws_s3control_multi_region_access_point":                          awsS3controlMultiRegionAccessPoint,
	"aws_s3control_multi_region_access_point_policy":                   awsS3controlMultiRegionAccessPointPolicy,
	...
	"aws_servicecatalog_organizations_access":                          awsServicecatalogOrganizationsAccess,
	...
	"aws_shield_application_layer_automatic_response":                  awsShieldApplicationLayerAutomaticResponse,
	...
	"aws_sns_topic_data_protection_policy":                             awsSnsTopicDataProtectionPolicy,
	...
	"aws_ssmcontacts_contact_channel":                                  awsSsmcontactsContactChannel,
	...
	"aws_timestreaminfluxdb_db_instance":                               awsTimestreamInfluxdbDBInstance,
	...
	"aws_vpc_route_server_endpoint":                                    awsVPCRouteServerEndpoint,
	"aws_vpc_route_server_peer":                                        awsVPCRouteServerPeer,
	...
	"aws_vpc_security_group_vpc_association":                           awsVPCSecurityGroupVPCAssociation,
	"aws_vpclattice_access_log_subscription":                           awsVPClatticeAccessLogSubscription,
	"aws_vpclattice_auth_policy":                                       awsVPClatticeAuthPolicy,
	"aws_vpclattice_listener":                                          awsVPClatticeListener,
	"aws_vpclattice_listener_rule":                                     awsVPClatticeListenerRule,
	...
	"aws_vpclattice_service_network_service_association":               awsVPClatticeServiceNetworkServiceAssociation,
	...
	"aws_vpclattice_target_group_attachment":                           awsVPClatticeTargetGroupAttachment,
	...
	"aws_waf_xss_match_set":                                            awsWafXssMatchSet,
	...
	"aws_wafregional_xss_match_set":                                    awsWafregionalXssMatchSet,
	...
	"aws_workspacesweb_browser_settings_association":                   awsWorkspaceswebBrowserSettingsAssociation,
	"aws_workspacesweb_data_protection_settings":                       awsWorkspaceswebDataProtectionSettings,
	"aws_workspacesweb_data_protection_settings_association":           awsWorkspaceswebDataProtectionSettingsAssociation,
	"aws_workspacesweb_identity_provider":                              awsWorkspaceswebIdentityProvider,
	"aws_workspacesweb_ip_access_settings":                             awsWorkspaceswebIPAccessSettings,
	"aws_workspacesweb_ip_access_settings_association":                 awsWorkspaceswebIPAccessSettingsAssociation,
	"aws_workspacesweb_network_settings":                               awsWorkspaceswebNetworkSettings,
	"aws_workspacesweb_network_settings_association":                   awsWorkspaceswebNetworkSettingsAssociation,
	"aws_workspacesweb_portal":                                         awsWorkspaceswebPortal,
	"aws_workspacesweb_session_logger":                                 awsWorkspaceswebSessionLogger,
	"aws_workspacesweb_session_logger_association":                     awsWorkspaceswebSessionLoggerAssociation,
