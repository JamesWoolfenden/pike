...
func TestCompare(t *testing.T) {
	...
	os.Setenv("GCP_PROJECT", "pike-477416")
...
func Test_compareGCPRole(t *testing.T) {
	...
	tests := []struct {
		...
		{"pass", args{"./testdata/gcp/basic", "projects/pike-477416/roles/terraform_pike", false}, false, false},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func TestVerifyRole(t *testing.T) {
	...
	tests := []struct {
		...
		{"Pass3", args{role: "projects/pike-477416/roles/terraform_pike"}, false, false},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
