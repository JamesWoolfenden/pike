...
func AzureDataLookup(name string) interface{} {
	TFLookupAzureData := map[string]interface{}{
		...
		"azurerm":                                                dataAzurermAzurerm,
		"azurerm_api_management":                                 dataAzurermAPIManagement,
		"azurerm_api_management_api":                             dataAzurermAPIManagementAPI,
		"azurerm_api_management_api_version_set":                 dataAzurermAPIManagementAPIVersionSet,
		...
		"azurerm_api_management_product":                         dataAzurermAPIManagementProduct,
		...
		"azurerm_automation_variable":                            dataAzurermAutomationVariable,
		...
		"azurerm_snapshot":                                       dataAzurermSnapshot,
		...
		"azurerm_virtual_machine_scale_set":                      dataAzurermVirtualMachineScaleSet,
