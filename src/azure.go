...
var tFLookupAzure = map[string]interface{}{
	...
	"azurerm_availability_set":                     azurermAvailabilitySet,
	...
	"azurerm_proximity_placement_group":            azurermProximityPlacementGroup,
	...
	"azurerm_shared_image":                         azurermSharedImage,
	"azurerm_shared_image_gallery":                 azurermSharedImageGallery,
	"azurerm_snapshot":                             azurermSnapshot,
	"azurerm_ssh_public_key":                       azurermSshPublicKey,
