...
resource "google_dialogflow_cx_page" "basic_page" {
    ...
    parameters {
      ...
      fill_behavior {
        ...
        reprompt_event_handlers {
          ...
          trigger_fulfillment {
            return_partial_responses = true
            webhook                  = google_dialogflow_cx_webhook.pike.id
            tag                      = "some-tag"
        ...
        reprompt_event_handlers {
          ...
          target_flow = google_dialogflow_cx_agent.pike.start_flow
        }
        reprompt_event_handlers {
  ...
  knowledge_connector_settings {
    ...
    data_store_connections {
      ...
      data_store               = "projects/${data.google_project.project.number}/locations/${google_dialogflow_cx_agent.pike.location}/collections/default_collection/dataStores/datastore-page-full"
